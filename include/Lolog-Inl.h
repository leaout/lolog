...
#undef X
    ...
    inline void set_color(bool set) {
        g_color = set;
    }

    inline void set_std_out(bool set) {
        kULog.m_std_out = set;
    }

    inline void set_print_file_line(bool set) {
        g_print_line = set;
    }

    inline void set_log_level(int set) {
    ...
    inline void set_log_formate(int formate) {
